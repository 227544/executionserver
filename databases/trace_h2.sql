...
--
--
DROP TABLE EXECUTION_TRACES IF EXISTS;
...
CREATE TABLE EXECUTION_TRACES (
  ...
  RULESET_PROPERTIES LONGVARCHAR,
  ELAPSED_TIME BIGINT,
  ...
  RULES LONGVARCHAR,
  TASKS LONGVARCHAR,
  EXECUTION_TRACE_TREE LONGVARCHAR,
  EXEC_OUTPUT LONGVARCHAR,
  INPUT_PARAMS LONGVARCHAR,
  OUTPUT_PARAMS LONGVARCHAR,
  EXECUTION_ID LONGVARCHAR NOT NULL,
  FULL_EXECUTION_TRACE LONGVARCHAR,
